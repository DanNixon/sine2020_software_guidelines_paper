...
A releted pattern in software development is DRY, or "don't repeat yourself".
This pattern encourages moving repeated code into common areas so that it may be reused, rather than developers repeating almost identical blocks of code multiple times.
