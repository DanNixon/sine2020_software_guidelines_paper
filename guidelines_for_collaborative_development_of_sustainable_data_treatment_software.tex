...
Release candidates are intended for "power users" who are happy to test the software for the benefit of the wider community (for example, a scientist who is responsible for an instrument and its associated user programme at a research infrastructure, and who wants to ensure your software works before providing it to their visiting users).
