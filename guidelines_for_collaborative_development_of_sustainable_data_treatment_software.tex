...
This paper presents a set of guidelines developed and used in the course of a 4-year international EU project
to facilitate collaborative development of inter-operable data treatment software among European neutron and muon sources. These guidelines are
specific, and over the course of the SINE2020 project helped to harmonize software development within this community.
Such specific guidelines should not be uncritically applied to the development of software within another community. Hence, for this
reason this paper also presents more generic guidelines for scientific software development from which more specific, and therefore more valuable,
guidelines applicable to a given community can be created.
