...
There is a plethora of testing frameworks available nowadays; almost every modern programming language ships a unit testing framework with its standard libraries (e.g. {\sc CxxTest}, {\sc unittest} and {\sc JUnit} for {\sc C++}, {\sc Python}, and {\sc Java} respectively). 
There are more advanced third party testing frameworks (e.g. {\sc GoogleTest}, {\sc GoogleMock}) that provide extended techniques for testing, such as mocking.
...
Hugo \cite{Hugo} and GitHub Pages \cite{GitHub_Pages} are examples of resources for creating landing pages.
