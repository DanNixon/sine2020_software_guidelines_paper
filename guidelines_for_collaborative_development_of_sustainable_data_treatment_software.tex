...
These guidelines are specific, and over the course of the SINE2020 project helped to harmonize software development within this community
...
We hope that these guidelines will help potential contributors to develop data treatment software of a high quality which can easily be adapted by neutron and muon sources
...
Therefore, it will be easier to continue growing the code base to include new scientific analysis and techniques and to adapt the software for instance at other facilities that the one that developed the software in the first place
...
The guidelines presented here are based on answers to a questionnaire to developers of data treatment software that are considered in SINE2020, namely Mantid, SasView, BornAgain, MuhRec / KipTool, and (TODO: full list) in addition to the ray-tracing programme McStas
The environment and processes surrounding these software packages are quite different spanning from small teams, where guidelines are needed for getting the software adapted by a larger user community and for getting more developers involved to ensure the software’s continuous success, to larger teams of around 20 developers distributed across the world, where guidelines are needed to ensure a consistent quality across the code base
