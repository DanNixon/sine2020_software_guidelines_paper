...
The report \cite{sine2020_wp10_d10_report} contains the standards and guidelines that were developed and used for WP10 of SINE2020. 
The guidelines are based on an analysis of the programs BornAgain, Mantid, McStas, MuhRec / KipTool, and SasView, and the report contains questionnaires, statistics and information about these programs including tables identifying commonality in the beginning of the SINE2020 project.
...
As can be seen from Table \ref{summaryTable} MatPlotLib is a common choice and it also has a large developer community supporting it, facilitating its long term sustainability. 
MatPlotLib has the advantage that it works seamlessly with Qt and also can be used seamlessly from a Jupyter notebook or a Python prompt in a terminal and it therefore seems to be a sensible choice for software with both a Python scripting interface and a GUI. 
