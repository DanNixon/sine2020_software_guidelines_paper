...
European Spallation Source  ERIC (ESS) are estimated to have data rates in the order of gigabytes per second \cite{Christensen_2018}, which is significantly higher than at existing neutron sources. 
Still, this level of data production is relatively small compared to other types of large-scale physics facilities, such as free electron lasers and the large hadron collider. 
...
A developer may also choose to contribute to existing software rather than develop her own from scratch.
...
In the case of data treatment, new methods are often developed in academia and it is therefore highly desirable if associated software can be readily adapted by facilities for the benefits of their users.
...
There is plenty of literature discussing different aspects of software development, which these days is a scientific and engineering discipline in its own right. 
...
A fact, which is often enhanced by the frequent turnover of PhD students and post docs, who often are the main developers and often working for themselves .... (TODO: citations).
...
Consequently, these software projects have a broad range of team sizes: from a couple of developers working very closely on a single piece of software to wide international collaborations (c.f., Section \ref{SINE2020}). 
