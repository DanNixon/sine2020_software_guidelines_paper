...
There are more advanced third party testing frameworks, such as {\sc GoogleTest} or {\sc GoogleMock}) that provide extended techniques for testing, for example mocking.
