...
As examples, the web sites SasView.org \cite{sasview} and BornAgainproject.org \cite{bornagain} are created with Jekyll and Hugo, respectively, and are both hosted on GitHub and served by GitHub Pages.
