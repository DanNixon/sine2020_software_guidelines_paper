...
In the neutron and muon science community NeXus \cite{K_nnecke_2015} has become the default format  for raw data and in some cases also for processed data \cite{cansas}.
...
Useful metadata (such as instrument configurations and data processing history) is trivial to store in NeXus  and is an important aspect for making data FAIR (i.e. Findable, Accessible, Inter-operable, and Reusable) \cite{panosc}.
