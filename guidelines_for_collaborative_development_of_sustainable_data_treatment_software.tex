...
Mocking is a technique in which a specific part of a codebase is tested by replacing components that it interacts with with "mock" components that allow injection of known values, checking function calls, etc.
