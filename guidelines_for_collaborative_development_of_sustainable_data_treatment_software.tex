...
\section{General Guidelines}\label{general)

This section will cover a variety of topics that are relevant to scientific software development. 
This part of the paper will use generic discussion to allow the reader to understand the basic principles and language of software development.
In section \ref{SINE2020} these generic guidelines will be applied to the neutron and muon communities.

It is important to define the day-to-day work of software developers (i.e. development methodologies, code review and coding standards) inorder for a project to be successful.
...
\subsection{Data Formats and Interoperability}
...
\subsection{Development Methodology}
\label{Development methodology2}

The neutron and muon communities are a good example of where there is a mixture of fixed and evolving requirments.
There will be some fixed requirments (e.g. data loading, performance targets and reduction) and some requirments will be added as new experiments are developed.
The fixed requirments would suit the waterfall development methodology. 
However, that would not allow for the addition of new requirments in response to new scientific research.
Therefore, within the waterfall milestones it is benefical to use an agile methodology. 
This will allow flexibility on prioritizing new requirments on the understanding this will delay some other work. 
