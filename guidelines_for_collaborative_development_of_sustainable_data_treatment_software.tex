...
Few will disagree on the benefit of good software architecture and design.
For smaller software, it may be sufficient to create such `on the back of an envelop` and simply have the resulting code with code documentation showcase the architecture and design.
However, for larger software or more complex software, this may lead to sub-optimal code design and design that may be hard for others to follow.
Many works in the literature have proposed optimal ways of documenting software design to ensure designs is efficiently communicated \& discussed with stakeholders at all levels, including by the team implementing the architecture.
There are some disagreements in the literature on the finer details of how this may be done best, but few disagree on the benefit this can provide. One example of a book covers this topic is: Documenting Software Architectures - Views and Beyond, 2nd Edition, Clements et al..
...
New data treatment software projects have developed their own guidelines to ensure a high quality and positive user experience.
