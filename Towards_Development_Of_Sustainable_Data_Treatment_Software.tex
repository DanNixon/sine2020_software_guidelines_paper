...
\author[B]{\inits{A.}\fnms{Anders} \snm{Kaestner}\ead[label=e5]{anders.kaestner@psi.ch}},
\author[C]{\inits{J.}\fnms{Joachim} \snm{Wuttke}\ead[label=e6]{j.wuttke@fz-juelich.de}},
\author[D]{\inits{M.}\fnms{Miguel} \snm{Gonzalez}\ead[label=e8]{gonzalezm@ill.fr}}
and
\author[E]{\inits{T. H.}\fnms{Thomas Holm} \snm{Rod}\ead[label=e4]{thomas.rod@esss.se}},
...
\address[B]{\orgname{Paul Scherrer Institute},\cny{Switzerland}\printead[presep={\\}]{e5}}
\address[C]{\orgname{Forschungszentrum Jülich},\cny{Germany}\printead[presep={\\}]{e6}}
\address[D]{\orgname{Institut Laue-Langevin},\cny{France}\printead[presep={\\}]{e8}}
\address[E]{\orgname{European Spallation Source},\cny{Denmark}\printead[presep={\\}]{e4}}
