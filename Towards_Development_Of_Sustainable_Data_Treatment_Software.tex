...
\begin{sidewaystable}[]
  \begin{tabular}{llllll}
    ...
    License                         & GPL3 &GPL3  &GPL2  &None  &BSD \\
  ...
  \end{tabular}
  \caption{A summary of how guidelines were applied to the different software projects from SINE2020 \cite{} (TODO: ref paper). The number of guidelines implemented increases with the size and scope of the project.}
  \label{summaryTable}
\end{sidewaystable}
