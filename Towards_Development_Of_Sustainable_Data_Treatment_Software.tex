...
The obvious action is to compilie/install the software and to run automated tests.
...
\section{SINE2020}
\label{SINE2020}
In this section some examples of how guidelines were applied to scientific software projects will be presented. All of these projects were part of the data treatment work package (WP 10) of Science and Innovation with Neutrons in Europe in 2020 (SINE2020). This was a four year project between 18 partner institutions spread across 12 different countries. One of the first pieces of work was to develop a report on ‘standards and guidelines` for neutron software development \cite{} (TODO: add cite). 
\begin{table}[]
\begin{tabular}{llllll}
 Software&BornAgain \cite{}  & Mantid \cite{} &McStats \cite{}  &MuhRec \cite{} & SasView \cite{} \\
Age of project (years)& 7 &9  &19  & 8 &13 \\
Number of developers (full time)&3  &20  & 5 & 2 & 2 to 20\\
Developer locations  &Single  &Multiple  & Multiple & Single &Multiple \\
License& GPL3 &GPL3  &GPL2  &Freeware  &BSD \\
Governance model & None &Project Management Board and advisory committees  &  Informal & Advisory committee  & Project Management Board & \\
Release cycles (per year)& a few & 3 & 1 & 1 & 1\\
 User documentation & Tutorials and examples online. & Web based and built-in and tutorials & PDF’s, online and wikis. & User manual & Online and built-in, tutorial. \\
\end{tabular}
\caption{A summary of how guidelines were applied to the different software projects from SINE2020 \cite{} (TODO: ref paper). The number of guidelines implemented increases with the size and scope of the project.}\label{summaryTable}
\end{table}
A summary of the main findings from the report \cite{} (TODO add) are presented in table \ref{summaryTable}. The larger projects, Mantid \cite{} and SasView \cite{} have more rigours guidelines for their projects. For example, they both have project management boards to decide the direction of the project. Whereas the smaller project do not need the overheads of a large project management structure. This is a good example of how guidelines should be adapted to match the needs of the project. 
