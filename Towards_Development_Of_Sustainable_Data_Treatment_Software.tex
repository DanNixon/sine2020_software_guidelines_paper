...
In this paper a series of guidelines are presented for scientific software development and a discussion of how the EU SINE2020 work-package 10 has used guidelines to develop high quality software.
...
Therefore, it is beneficial to develop code that is easy to maintain, extend (new functionality) and does not have duplicated effort.
...
For more information on how each of these projects uses guidelines please see \cite{} (TODO: add RAL Tech report ref).   
