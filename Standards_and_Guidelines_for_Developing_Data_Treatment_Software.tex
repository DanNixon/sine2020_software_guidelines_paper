...
A community curated list of standards organised by language is available here: https://github.com/Kristories/awesome-guidelines TODO: Refs to those used for data treatment in neutron scattering / considered in SINE2020 (e.g. Mantid, SasView, BornAgain, MuhRec, etc).
...
As the technology becomes more popular it is worth looking into cross platform container based means of distribution (for example, Docker (TODO: link) and Singularity \cite{Kurtzer_2017} and other container based systems).
